...
import "../styles/style.css"; // Ensure this import path is correct
                                    ...
                                    <nav className="navbar-desktop">
                                        <ul className="navbar-ul-desktop">
                                            <li className="navbar-li-desktop">
                                                <a href="#" className="navbar-link-desktop">Home</a>
                                            </li>
                                            <li className="navbar-li-desktop">
                                                <a href="#" className="navbar-link-desktop">Profile</a>
                                            </li>
                                            <li className="navbar-li-desktop">
                                                <a href="#" className="navbar-link-desktop">Artikel</a>
                                            </li>
                                            <li className="navbar-li-desktop">
                                                <a href="#" className="navbar-link-desktop">Informasi</a>
                                            </li>
                                        </ul>
                                    </nav>
                                        ...
                                        <nav className="mobile-navbar">
                                            <ul className="navbar-ul-mobile">
                                                <li className="navbar-li-mobile">
                                                    <a href="#" className="navbar-link-mobile" onClick={toggleNav}>Home</a>
                                                </li>
                                                <li className="navbar-li-mobile">
                                                    <a href="#" className="navbar-link-mobile" onClick={toggleNav}>Profile</a>
                                                </li>
                                                <li className="navbar-li-mobile">
                                                    <a href="#" className="navbar-link-mobile" onClick={toggleNav}>Artikel</a>
                                                </li>
                                                <li className="navbar-li-mobile">
                                                    <a href="#" className="navbar-link-mobile" onClick={toggleNav}>Informasi</a>
                                                </li>
                                                <li className="navbar-li-mobile">
                ...
                <div className="inner-container">
                    <section className="hero-section">
                        <div className="hero-content">
                            <p className="hero-subtitle">Feel The Convenience</p>
                    ...
                    <section className="section help-section-card help-section">
                        ...
                        <div className="help-content-wrapper">
                            ...
                            <ul className="help-section-list">
                                <li>Menyelenggarakan pendidikan yang berkualitas dengan kurikulum yang relevan.</li>
